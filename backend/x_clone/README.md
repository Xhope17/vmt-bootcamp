...
dotnet ef dbcontext scaffold "Server=localhost,1433;User=sa;Password=Admin1234@;Database=XClone;TrustServerCertificate=true" Microsoft.EntityFrameworkCore.SqlServer --project Xclone.Domain --startup-project XClone.WebApi --no-build --force --context-dir Database/SqlServer/Context --output-dir Database/SqlServer/Entities --no-onconfiguring
